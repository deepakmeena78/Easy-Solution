...
const SliderProfile = () => {
    ...
    return (
        <div>
            ...
            <div className={`fixed top-0 left-0 h-full bg-[var(--light-blue)] text-black p-5 w-64 z-40 transform ${isOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 transition-transform duration-300 ease-in-out`}>
                {/* Profile Section */}
                <div className="flex flex-col items-center mb-5">
                    <img src="https://via.placeholder.com/80" alt="Profile" className="w-20 h-20 rounded-full border-2 border-white" />
